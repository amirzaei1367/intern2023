...
def append_to_csv(filename, data):
    with open(filename, 'a', newline='') as csvfile:
        fieldnames = ['first_name', 'last_name', 'security_clearance', 'certifications', 'skills', 'education', 'work_history']
...
class FieldsExtractionService(APIView):
    ...
    def extract_fields_from_resume(self, resume_text):
        ...
        prompts = [
            ...
            f"LLAMA: Here is a resume:\n{resume_text}\n\nUser: What are the job titles abd companies of employment in the work history of the person from this resume? (Respond only with each employment formated as 'Company - Job Title') (Seperate entries with commas) (Respond in the form 'Answer: '):"
        ]

        max_new_tokens_values = [20, 20, 20, 50, 200, 200, 200]
        responses = []
